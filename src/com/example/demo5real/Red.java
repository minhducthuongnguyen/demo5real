...
int point=0;
	...
	int[] colorlist= {0xFFFF0000,0xFFFF3333,0xffFF6666,0xffFF9999,0xffFFCCCC,0xffCC0000,0xff990000,0xff660000,0xff330000};
	TextView tv3;
	int score;
	boolean game=true;
	Button b0000;
...
//get best score
		...
		score = prefs.getInt("ulthescore", 0); 
...
cd=new CountDownTimer(1500, 1) {
	 ...
	 public void onFinish() {
		 ...
		 Intent intent=new Intent(context, UScore.class);
